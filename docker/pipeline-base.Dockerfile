...
RUN apk add boost-program_options gcc libc-dev libc6-compat libstdc++  fortify-headers linux-headers --repository=http://dl-cdn.alpinelinux.org/alpine/edge/main
